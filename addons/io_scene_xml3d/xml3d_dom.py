...
class XML3DDocument(Document):
    ...
    def createTransformElement(self, id_=None, translation_=None, scale_=None, rotation_=None, center_=None,
                               scaleOrientation_=None):
    ...
    def createTextureElement(self, id_=None, name_=None, type_=None, filterMin_=None, filterMag_=None, filterMip_=None,
                             wrapS_=None, wrapT_=None, wrapU_=None, borderColor_=None):
        #print 'Creating element  texture'
        e = _TextureElement(self, id_, name_, type_, filterMin_, filterMag_, filterMip_, wrapS_, wrapT_, wrapU_,
                            borderColor_)
        #e.ownerDocument = self
        return e
...
class _TextureElement(_XML3DElement):
    ...
    def __init__(self, doc_, id_, name_, type_, filterMin_, filterMag_, filterMip_, wrapS_, wrapT_, wrapU_,
                 borderColor_):
